...
namespace OmegaRace
{
    ...
    {
        public const string WindowCaption = "Omega Race - Client - Client Prediction";
        ...
        public override void Initialize()
        {
            ...
            this.SetWindowName(WindowCaption + rnd.Next().ToString());
