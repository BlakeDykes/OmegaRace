...
namespace OmegaRace
{
    public class GameManager
    {
        ...
        public static void AddPlayer(byte playerId)
        {
            ...
            PlayerName playerName = NetworkEnvManager.GetPlayerName();

            GameSceneCollection.ScenePlay.AddPlayer(playerId, playerName);
        }
        ...
        /// <summary>
        /// Initializes a ServerManager network environment and a server play scene
        /// </summary>
        public static void InitializeServer()
        {
            NetworkEnvManager.InitializeServerEnv();
            PredictionManager.Initialize(PREDICTION_TYPE.PosP_Null);

            GameManager.ChangeState(GameSceneCollection.SceneConnecting);
            GameSceneCollection.ScenePlay.InitializeServer();
        ...
        {
            GameManager.ChangeState(GameSceneCollection.ScenePlay);
            Instance()._GameLoop = new GL_Network_Server();
            GameSceneCollection.ScenePlay.StartServer();
        }
